...
PROJECT_INITIAL_DATE="2022-05-24"
PROJECT_SHORT_DESC="An unofficial Python 3 client for Notion.so API"

PROJECT_NAME="Python Client for Notion.so"
PYTHON_PACKAGE_NAME="notionlib"                 # TODO e.g. pyax12 (all in lower case and without special character)

PROJECT_GITHUB_ACCOUNT="jdhp"              # TODO (GitLab)
#PROJECT_GITHUB_ACCOUNT="jeremiedecock"     # TODO (GitHub)
PROJECT_GITHUB_REPOSITORY_NAME="notion-lib"
